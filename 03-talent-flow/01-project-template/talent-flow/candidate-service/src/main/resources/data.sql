...
INSERT INTO candidate(name, email, phone, location, experience_in_years, skills)
    ...
    ('Brian Carter',  'brian.carter@example.com',   '+1-555-234-5678', 'Austin, TX', 5, ARRAY['Golang', 'gRPC', 'Kubernetes', 'PostgreSQL']);
...
INSERT INTO work_experience (candidate_id, company_name, job_title, start_date, end_date, description, technologies)
    ...
    (2, 'StreamLogic Inc.', 'Golang Backend Engineer', DATE '2019-08-01', DATE '2023-02-28', 'Developed high-performance microservices using Golang and gRPC.', ARRAY['Golang', 'gRPC', 'Kubernetes', 'Prometheus', 'Docker']),
    (2, 'NextGen Cloud Services', 'Software Engineer',  DATE '2017-06-01', DATE '2019-07-31', 'Built cloud-native backend solutions with Go.', ARRAY['Golang', 'REST API', 'PostgreSQL', 'Terraform']);
